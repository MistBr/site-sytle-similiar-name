  ...
  import circuitoControleLed from '@/assets/images/circuitocontroleled.jpg';
  import roboSeguidorLinha from '@/assets/images/roboseguidordelinha.jpg';
  import controladorPidMotores from '@/assets/images/controladorpidmotores.jpg';
  import modelo3dSensorDistancia from '@/assets/images/modelo3dsensordistancia.jpg';
  import circuitoAlimentacaoSolar from '@/assets/images/circuitoalimentacaosolar.jpg';
  import roboHexapod from '@/assets/images/robohexapod.jpg';
  import controleDrone from '@/assets/images/controledrone.jpg';
  import arduinoCase from '@/assets/images/arduino.jpg';
  import controladorTemperatura from '@/assets/images/controladortemperatura.jpg';
  ...
  const Workshop = () => {
    ...
    const sampleProjects: Project[] = [
      ...
      },
      {
        ...
        author: "Pedro Santos",
        thumbnail: modelo3dSensorDistancia,
        category: "controls",
        downloads: 210,
        likes: 78
      },
      {
        ...
        author: "Ana Pereira",
        thumbnail: controladorPidMotores,
        category: "3d",
        downloads: 150,
        likes: 56
      },
      {
        ...
        thumbnail: circuitoAlimentacaoSolar,
        category: "eletronics",
        downloads: 95,
        likes: 41
      },
      ...
      },
      {
        ...
        thumbnail: controladorTemperatura,
        category: "controls",
        downloads: 140,
        likes: 53
      }
  ...
  if (projectsToRender.length === 0) {
    return <p className="text-gray-600">Nenhum projeto encontrado.</p>;
  }
